...
Then, run `docker compose up` to start the local server. Afterwards, navigate to [http://127.0.0.1:3000/home](http://127.0.0.1:3000/home) or localhost in order to view the website locally. Run `docker compose down` to close the local server.
